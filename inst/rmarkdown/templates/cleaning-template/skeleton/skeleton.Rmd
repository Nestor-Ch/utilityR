...
polygon_file_merge_column <-'' # what is the name of the column that signifies the name of the polygon in your json file?
merge_column <- '' # what is the name of the column that signifies the name of the polygon in your dataframe?
