...
geo_column <- '' # the name of the column that holds your coordinates (in the data).Leave blank if not using
polygon_file <- 'resources/UKR_ADM4_2020.geojson' # the file with polygons that were supposed to be sampled
polygon_file_merge_column <-'' # what is the name of the column that signifies the name of the polygon in your json file? Leave blank if not using
merge_column <- '' # what is the name of the column that signifies the name of the polygon in your dataframe? Leave blank if not using
