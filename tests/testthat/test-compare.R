...
testthat::test_that('compare_columns works - test 1 basic non loop functionality',{
...
testthat::test_that('compare_columns works - test 2 - test if it works with loops',{
...
testthat::test_that('compare_columns works - test 3 - remove unnecessary ids if any',{
...
testthat::test_that('compare_columns works - test 4 - remove unnecessary columns if any',{
...
testthat::test_that('compare_columns works - test 5 - make sure that the user has passed the correct columns',{
...
testthat::test_that('compare_columns works - test 6 - make sure that the user has passed the correct columns',{
...
testthat::test_that('compare_columns works - test 7 - make sure that the user has passed the correct columns',{
  ...
  raw_data$loop_index <- 1:10
  clean_data$loop_index <- 1:10
...
testthat::test_that('compare_columns works - test 8 - make sure that the user has passed the correct columns',{
...
testthat::test_that('compare_rows works - test 1- basic functionality',{
...
testthat::test_that('compare_rows works - test 2- test that it works with loops',{
...
testthat::test_that('compare_rows works - test 3 - make sure that the user has passed the correct columns',{
...
testthat::test_that('compare_rows works - test 4 - make sure that the user has passed the correct columns',{
...
testthat::test_that('compare_rows works - test 5 - make sure that the user has passed the correct columns',{
...
testthat::test_that('compare_rows works -  test 6 - make sure that the user passed data with id columns',{
...
testthat::test_that('compare_rows works -  test 7 -more ids',{
...
testthat::test_that('compare_rows works -  test 8 - nothing was deleted',{
